...
(function( $, window, document, undefined ) {
	...
	var __MediaGallery = {
		...
		setMyImage: function () {
			...
			$.get( Event.URL + 'photos/albumsList', function (res) {
		...
		setItemImage: function (data) {
			...
			$checkbox.append( 
				''
				  // '<svg width="24px" height="24px" class="JUQOtc kWbB0e" viewBox="0 0 24 24"><circle cx="12" cy="12" r="17"></circle></svg>'

				// , '<svg width="24px" height="24px" class="JUQOtc rqet2b" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"></path></svg>' 

				// , '<svg width="24px" height="24px" class="JUQOtc eoYPIb" viewBox="0 0 24 24"><circle cx="12.5" cy="12.2" r="8.292"></circle></svg>' 


				// , '<svg width="24px" height="24px" class="JUQOtc aiEkg" viewBox="0 0 24 24"><radialGradient id="shadow" cx="38" cy="95.488" r="10.488" gradientTransform="matrix(1 0 0 -1 -26 109)" gradientUnits="userSpaceOnUse"><stop offset=".832" stop-color="#010101"></stop><stop offset="1" stop-color="#010101" stop-opacity="0"></stop></radialGradient><circle opacity=".26" fill="url(#shadow)" cx="12" cy="13.512" r="10.488"></circle><circle fill="#FFF" cx="12" cy="12.2" r="8.292"></circle></svg>' 
		...
		displayImages: function () {
            ...
            for (var i = 0; i < rows.length; i++) {
                ...
                for (var j = 0; j < row.photos.length; j++) {
                	...
                	$(photo).find('.pic').prograssiveImage({
                		url: data.url,
                		width: wt,
                		height: ht,
                	});
